    ...
    >
      <n-grid :cols="24" :x-gap="12" :y-gap="2">
        <n-form-item-gi :span="6" label="订单总报价" path="oldPrice">
          <n-input-number v-model:value="form.oldPrice" clearable :readonly="true" />
        </n-form-item-gi>

        <n-form-item-gi :span="6" label="订单调整后总报价" path="newPrice">
          <n-input-number v-model:value="form.newPrice" clearable :readonly="true" />
        </n-form-item-gi>

        <n-form-item-gi :span="6" label="订单浮动费" path="oldFloatCost">
          <n-input-number v-model:value="form.oldFloatCost" clearable :readonly="true" />
        </n-form-item-gi>

        <n-form-item-gi :span="6" label="订单调整后浮动费" path="newFloatCost">
          <n-input-number v-model:value="form.newFloatCost" clearable :readonly="true" />
        </n-form-item-gi>
        ...
        <n-form-item-gi :span="12" label="订单里程费" path="orderMileageCost">
          <n-input-number v-model:value="form.orderMileageCost" clearable :disabled="true" />
        </n-form-item-gi>
        ...
        <n-form-item-gi :span="12" label="订单时长费" path="orderDurationCost">
          <n-input-number v-model:value="form.orderDurationCost" clearable :disabled="true" />
        </n-form-item-gi>
