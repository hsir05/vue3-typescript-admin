  ...
  <div class="flex-align-start order-detail h-full">
    <div class="left">
      <n-descriptions label-placement="left" bordered :column="2">
        ...
        <n-descriptions-item label="订单业务类型" :span="2">{{ order?.orderBusinessType }}</n-descriptions-item>
        ...
        <n-descriptions-item label="接单司机姓名" :span="2">{{ order?.driverFullName }}</n-descriptions-item>
        <n-descriptions-item label="接单司机工号" :span="2">{{ order?.driverNo }}</n-descriptions-item>
        <n-descriptions-item label="接单司机电话" :span="2">{{ order?.driverPhone }}</n-descriptions-item>
        <n-descriptions-item label="接单车型" :span="2">{{ order?.plateNumber }}</n-descriptions-item>
        <n-descriptions-item label="订单状态" :span="2">{{ order?.orderState }}</n-descriptions-item>
      </n-descriptions>
