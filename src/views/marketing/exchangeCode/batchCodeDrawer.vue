<template>
  <BasicDrawer v-model:show="isDrawer" title="批量添加代金券" @on-close-after="onCloseAfter">
    ...
    <div class="pb-5px text-right">
      <n-button attr-type="button" type="primary" @click="handleBatch">批量添加</n-button>
      <n-button attr-type="button" type="primary" @click="handleBatchVoucher"
        >批量添加代金券</n-button
      >
    </div>
    <n-data-table
