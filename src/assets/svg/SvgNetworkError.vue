<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
    ...
    <g id="freepik--Device--inject-163">
      ...
      />
      <path
        d="M123.5,77.2a2.34,2.34,0,1,0-2.33,2.34A2.33,2.33,0,0,0,123.5,77.2Z"
        style="fill: #707070"
      />
      <path
      ...
      <path
        ...
        style="fill: #263238"
      />
      <path d="M60.38,83.73v1.08h-.84V83.73Zm0,4.26v1.08h-.84V88Z" style="fill: #263238" />
      <path
      ...
      <path
        ...
        style="fill: #263238"
      />
      <rect x="152.41" y="83.47" width="2.21" height="5.53" style="fill: #263238" />
      <rect x="155.36" y="82.36" width="2.21" height="6.64" style="fill: #263238" />
      <rect x="158.31" y="81.57" width="2.21" height="7.42" style="fill: #263238" />
      <rect x="161.25" y="80.2" width="2.21" height="8.79" style="fill: #263238" />
      <path
        d="M190.83,88.84H177.56V80.73h13.27Zm-12.53-.73h11.79V81.47H178.3Z"
        style="fill: #263238"
      />
      <rect x="179.41" y="82.27" width="7" height="5.03" style="fill: #263238" />
      <rect x="190.37" y="83.83" width="1.67" height="1.91" style="fill: #263238" />
      <path
      ...
      />
      <path
        d="M171.21,87.91A1.25,1.25,0,1,1,170,86.67,1.24,1.24,0,0,1,171.21,87.91Z"
        style="fill: #263238"
      />
      <path
      ...
      />
      <path
        d="M121.52,299.5a10.2,10.2,0,1,1,10.17-10.15A10.14,10.14,0,0,1,121.52,299.5Z"
        style="fill: #263238"
      />
      <path
